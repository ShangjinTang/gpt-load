...
type KeyValidator struct {
	...
	statusUpdater   interfaces.KeyStatusUpdater
...
func (s *KeyValidator) ValidateSingleKey(key *models.APIKey, group *models.Group) (bool, error) {
	...
	s.statusUpdater.UpdateStatus(key, group, isValid, errorMsg)
...
func (s *KeyValidator) TestMultipleKeys(group *models.Group, keyValues []string) ([]interface{}, error) {
	...
	// Convert results to []interface{} for the interface
